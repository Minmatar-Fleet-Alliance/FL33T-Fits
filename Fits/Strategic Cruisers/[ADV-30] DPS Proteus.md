...
Mainline DPS alternative for the 10mn Beam Legion fleet. EWAR refits in cargo.

## Fit
```
[Proteus, [ADV-30] DPS Proteus]
...
DDO Scoped Tracking Disruptor I x1
Highstroke Scoped Guidance Disruptor x1
Proteus Defensive - Covert Reconfiguration x1
```
